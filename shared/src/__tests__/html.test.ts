...
// Add Node.js global type definition
declare const global: typeof globalThis;

global.jest = jest;
global.test = test;
//@ts-expect-error error anticipated
...
describe('HTML Utilities', () => {
  describe('htmlToPlainText', () => {
    ...
    it('should format blockquotes', () => {
      const html = '<p>Text</p><blockquote>Quoted text</blockquote><p>More text</p>';
      const plainText = htmlToPlainText(html);
  ...
  describe('processPostsContent', () => {
    ...
    it('should handle non-array input', () => {
      ...
      expect(processPostsContent(nonArray as unknown as PostWithHtml[])).toBe(nonArray);
    });
  });
