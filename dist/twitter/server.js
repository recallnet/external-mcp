...
export function createTwitterServer(options = {}) {
    ...
    if (twitterFeatures.fullAuth &&
        ...
        server.tool("twitter-get-dm-conversations", "Gets direct message conversations for the authenticated user.", {
        ...
        // Send direct message
        server.tool("twitter-send-dm", "Sends a direct message to another user.", {
            conversationId: z
                .string()
    ...
    if (twitterFeatures.grokAccess &&
        ...
        server.tool("twitter-grok-chat", "Sends a message to Grok AI and gets a response.", {
...
if (process.argv[1].endsWith("twitter/server.js") ||
